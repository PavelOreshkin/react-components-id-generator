...
|  `space_replacer`   |                                          string?                                           | to replace spaces in attributes (`${attr:onClick}` in Patterns below), for example space_replacer="-" transform `label="first name"` replace to `first-name` in id                                                                                                                                                                      |
|       `rules`       |                                 {tag, pattern, id_name?}[]                                 | rules Rules for generating the ID string                                                                                                                                                                                                                                                                                                |
|        `tag`        |                                     string \| string[]                                     | tag name of the element to which the pattern will be applied. For example: `button`, `Button`, `Button.SuperButton` (yeap, compound tags also work)                                                                                                                                                                                     |
|      `pattern`      |                                           string                                           | pattern according to which the string will be generated.                                                                                                                                                                                                                                                                                |
| `id_name` (in rule) |                                          string?                                           | name of the generated ID for this specific rule. If not specified, uses the global `id_name` from config. Useful for wrapper components that use camelCase props (e.g., `dataQa`) instead of kebab-case attributes (e.g., `data-qa`).                                                                                                   |
